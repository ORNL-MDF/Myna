...
# Get example STL location from the repository example databases (assuming this is
# running from this script's example directory within the repo examples tree)
stl_path = os.path.join(
    "..", "..", "databases", "Peregrine", "simulation", "meltpool", "P5", "part.stl"
)
